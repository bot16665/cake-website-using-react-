      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              Creating beautiful, delicious cakes for every special occasion. 
              We bring your sweetest dreams to life with love and creativity.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/cakes" className="text-gray-300 hover:text-pink-400 transition-colors">
                  Our Cakes
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li className="flex items-center space-x-2">
                <span>📧</span>
                <span>azharshaikh40198@gmail.com</span>
              </li>
              <li className="flex items-center space-x-2">
                <span>📍</span>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">
            © 2025 Sweet Dreams. All rights reserved. created by Azhar Shaikh
          </p>
